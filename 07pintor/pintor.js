...
$(document).ready(function(){
	...
	$("#rojo").click(function(){
		$("#lienzo").mousemove(function(event){
			var x= event.pageX;
			var y= event.pageY;
			$("#lienzo").append('<div style="position:absolute;width:10px;height:10px;background:rgba(255,0,0,0.1);border-radius:5px;transform:translate('+x+'px,'+y+'px)"</div>');
		})
	});
	...
	$("#azul").click(function(){
		$("#lienzo").mousemove(function(event){
			var x= event.pageX;
			var y=event.pageY;
			$(this).append('<div style="position:absolute;width:10px;height:10px;background:rgba(0,0,255,0.1);border-radius:5px;transform:translate('+x+'px,'+y+'px)"</div>');
		})
	});
	...
	$("#verde").click(function(){
		$("#lienzo").mousemove(function(event){
			var x= event.pageX;
			var y=event.pageY;
			$(this).append('<div style="position:absolute;width:10px;height:10px;background:rgba(0,255,0,0.1);border-radius:5px;transform:translate('+x+'px,'+y+'px)"</div>');
		})
	});
});
